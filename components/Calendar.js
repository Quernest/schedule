...
export default class Calendar extends PureComponent<Props, State> {
  ...
  getDates = (): Array<Moment> => {
    ...
    // Go `showDaysBeforeCurrent` ago before today or custom `selectedDate`
    const startDay = moment(selectedDate || undefined)
